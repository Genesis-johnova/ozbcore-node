  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.ozbcore/data',
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.ozbcore/ozbcore-node.json');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.ozbcore/data');
