...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ozbcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ozbcore-node add wallet-service');
      console.log('    $ ozbcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ozbcore-node remove wallet-service');
      console.log('    $ ozbcore-node remove insight-api');
      console.log();
    });
