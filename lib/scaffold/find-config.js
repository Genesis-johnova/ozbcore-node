...
/**
 * Will return the path and ozbcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'ozbcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'ozbcore-node.json'))
  };
}
