...
```bash
ozbcore-node create -d <bitcoin-data-dir> mynode
cd mynode
ozbcore-node install <service>
ozbcore-node install https://github.com/yourname/helloworld
```
...
Code released under [the MIT license](https://github.com/ozosbittglobal/ozbcore-node/blob/master/LICENSE).
